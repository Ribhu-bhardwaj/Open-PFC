...
ANNEXURE = "1.6"
TABLE_HEADER = "Net Worth, Consumer Contribution & Total Borrowings"

INPUT_FOLDER = r"C:\Users\ribhu\csep-hermes\input"

# ALL CSV FILES GO INSIDE THIS ONE FOLDER
OUTPUT_FOLDER = (
    r"C:\Users\ribhu\csep-hermes\outputs\Net Worth, Consumer Contribution & Total Borrowings\23-24"
)
...
COLUMNS = [
    ...
    "Govt_Grants_and_Subsidies_for_Capital_Assets",
    "Net_Worth",
    "Consumers_Contribution_towards_Capital_Assets",
    "State_Government_Borrowings",
    "Total_Borrowings_Incl_State_Govt_Borrowings"
]

NUM_COLS = 8
UNITS = ["Rs crore", "Rs crore", "Rs crore", "Rs crore", "Rs crore", "Rs crore", "Rs crore", "Rs crore"]
...
skip_patterns = [
    'Net Worth, Consumer Contribution',
    'Total Borrowings',
    'Rs crore',
    'As on March 31',
    'Govt. Grants',
    ...
    with pdfplumber.open(pdf_path) as pdf:
        ...
        for year_label, page_indices in blocks:
            ...
            output_path = os.path.join(
                OUTPUT_FOLDER,
                f"Net-Worth-and-Total-Borrowings-{short_year}.csv"
            )
