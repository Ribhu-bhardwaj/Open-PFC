...
OUTPUT_FOLDER = (
    r"C:\Users\ribhu\csep-hermes\outputs\Revenue Structure on Energy Sold basis\23-24"
)
...
COLUMNS = [
    ...
    "Other_Operating_Income_incl_Wheeling_Charges",
    "Tariff_Subsidy",
...
NUM_COLS = 8
UNITS = ["MU", "Rs/kWh", "Rs/kWh", "Rs/kWh", "Rs/kWh", "Rs/kWh", "Rs/kWh", "Rs/kWh"]
...
skip_patterns = [
    'Revenue Structure on Energy Sold basis',
    'Rs./kWh',
    'ARR on Energy',
    'Other',
    'Sold excluding',
    ...
    with pdfplumber.open(pdf_path) as pdf:
        ...
        for year_label, page_indices in blocks:
            ...
            output_path = os.path.join(
                OUTPUT_FOLDER,
                f"Revenue-Structure-Energy-Sold-{short_year}.csv"
            )
