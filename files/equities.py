...
ANNEXURE = "1.5"
TABLE_HEADER = "Total Equity and Liabilities"

INPUT_FOLDER = r"C:\Users\ribhu\csep-hermes\input"

# ALL CSV FILES GO INSIDE THIS ONE FOLDER
OUTPUT_FOLDER = (
    r"C:\Users\ribhu\csep-hermes\outputs\Total Equity and Liabilities\23-24"
)
...
COLUMNS = [
    "Equity_and_Capital_Reserves",
    "Other_Non_Current_Borrowings",
    "Current_Liabilities",
    "Current_Maturities_on_LT_Borrowings_and_ST_Borrowings",
    "Interest_Accrued_and_Due",
    "Payables_for_Power_Purchase",
    "Other_Current_Liabilities",
    "Total_Equity_and_Liabilities",
    "Payables_for_Power_Purchase_Days"
]

NUM_COLS = 9
UNITS = ["Rs crore", "Rs crore", "Rs crore", "Rs crore", "Rs crore", "Rs crore", "Rs crore", "Rs crore", "Days"]
    ...
    with pdfplumber.open(pdf_path) as pdf:
        ...
        for year_label, page_indices in blocks:
            ...
            output_path = os.path.join(
                OUTPUT_FOLDER,
                f"Total-Equity-and-Liabilities-{short_year}.csv"
            )
