...
ANNEXURE = "1.9"
TABLE_HEADER = "Consumer Category-wise Break-up (%) of Sales (MU)"

INPUT_FOLDER = r"C:\Users\ribhu\csep-hermes\input"

# ALL CSV FILES GO INSIDE THIS ONE FOLDER
OUTPUT_FOLDER = (
    r"C:\Users\ribhu\csep-hermes\outputs\Consumer Category-wise Break-up (%) of Sales (MU)\23-24"
)
...
skip_patterns = [
    'Consumer Category-wise Break-up (%) of Sales',
    'Gross Energy sold',
    '(MU) Domestic (%) Commercial (%) Agricultural (%) Industrial (%) Others (%)',
    'Annexure',
    'Section 1',
    ...
    with pdfplumber.open(pdf_path) as pdf:
        ...
        for year_label, page_indices in blocks:
            ...
            output_path = os.path.join(
                OUTPUT_FOLDER,
                f"Consumer-Category-Sales-Breakup-{short_year}.csv"
            )
