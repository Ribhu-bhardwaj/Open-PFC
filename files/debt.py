...
ANNEXURE = "1.7"
TABLE_HEADER = "Debt Service Coverage Ratio (Cash Adjusted)"

INPUT_FOLDER = r"C:\Users\ribhu\csep-hermes\input"

# ALL CSV FILES GO INSIDE THIS ONE FOLDER
OUTPUT_FOLDER = (
    r"C:\Users\ribhu\csep-hermes\outputs\Debt Service Coverage Ratio (Cash Adjusted)\23-24"
)
...
COLUMNS = [
    "Cash_Adjusted_EBITDA",
    "Total_Interest_Cost",
    "Opening_Current_Maturities_on_LT_Borrowings_and_Interest_Accrued_Due",
    "DSCR_Cash_Adjusted"
]

NUM_COLS = 4
UNITS = ["Rs crore", "Rs crore", "Rs crore", "Ratio"]
    ...
    with pdfplumber.open(pdf_path) as pdf:
        ...
        for year_label, page_indices in blocks:
            ...
            output_path = os.path.join(
                OUTPUT_FOLDER,
                f"DSCR-Cash-Adjusted-{short_year}.csv"
            )
