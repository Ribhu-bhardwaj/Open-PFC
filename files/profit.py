...
ANNEXURE = "1.3"
TABLE_HEADER = "Profitability and Gap"

INPUT_FOLDER = r"C:\Users\ribhu\csep-hermes\input"

# ALL CSV FILES GO INSIDE THIS ONE FOLDER
OUTPUT_FOLDER = (
    r"C:\Users\ribhu\csep-hermes\outputs\Profitability and Gap\23-24"
)
...
COLUMNS = [
    "Gross_Input_Energy",
    "Profit_Loss_on_Accrual_Basis_PAT",
    "Profit_Loss_with_Tariff_Subsidy_Received",
    "Profit_Loss_with_Tariff_Subsidy_Received_Excl_Reg_Income_and_Revenue_Grant_UDAY",
    "Gap_on_Tariff_Subsidy_Billed_Basis",
    "Gap_on_Tariff_Subsidy_Received_Basis",
    "Gap_on_Tariff_Subsidy_Received_Excl_Reg_Income_and_Revenue_Grant_UDAY"
]

NUM_COLS = 7
UNITS = ["MU", "Rs crore", "Rs crore", "Rs crore", "Rs/kWh", "Rs/kWh", "Rs/kWh"]
    ...
    with pdfplumber.open(pdf_path) as pdf:
        ...
        for year_label, page_indices in blocks:
            ...
            output_path = os.path.join(
                OUTPUT_FOLDER,
                f"Profitability-and-Gap-{short_year}.csv"
            )
