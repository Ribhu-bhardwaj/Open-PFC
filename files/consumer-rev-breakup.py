...
COLUMNS = [
    "Revenue_from_Sale_of_Power_Incl_Tariff_Subsidy_Billed",
    "Domestic",
    "Commercial",
    "Agricultural",
    "Industrial",
...
skip_patterns = [
    'Consumer Category-wise Break-up (%) of Revenue from Sale of Power',
    'Revenue from',
    'Sale of Power',
    'including Tariff',
    'Subsidy Billed (Rs',
    'crore) Domestic (%) Commercial (%) Agricultural (%) Industrial (%) Others (%) Tariff Subsidy (%)',
    'Annexure',
    'Section 1',
    ...
    with pdfplumber.open(pdf_path) as pdf:
        ...
        for year_label, page_indices in blocks:
            ...
            output_path = os.path.join(
                OUTPUT_FOLDER,
                f"Consumer-Category-Revenue-Breakup-{short_year}.csv"
            )
