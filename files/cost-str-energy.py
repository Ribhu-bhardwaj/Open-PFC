...
ANNEXURE = "1.2(b)"
TABLE_HEADER = "Cost Structure on Energy Sold basis"

INPUT_FOLDER = r"C:\Users\ribhu\csep-hermes\input"

# ALL CSV FILES GO INSIDE THIS ONE FOLDER
OUTPUT_FOLDER = (
    r"C:\Users\ribhu\csep-hermes\outputs\Cost Structure on Energy Sold basis\23-24"
)
...
skip_patterns = [
    'Cost Structure on Energy Sold basis',
    'Rs./kWh',
    'Cost of Power',
    '(including own',
    'ACS on Energy',
    ...
    with pdfplumber.open(pdf_path) as pdf:
        ...
        for year_label, page_indices in blocks:
            ...
            output_path = os.path.join(
                OUTPUT_FOLDER,
                f"Cost-Structure-Energy-Sold-{short_year}.csv"
            )
