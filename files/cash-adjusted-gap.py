...
COLUMNS = [
    "Gross_Input_Energy",
    "Total_Revenue_Excl_Reg_Income_and_Revenue_Grant_UDAY",
    "Unrealised_Revenue_from_Sale_of_Power",
    "Unrealized_Tariff_and_Non_Tariff_Subsidies",
    "Cash_Adjusted_Revenue",
    "Cash_Adjusted_ARR",
    "Cash_Adjusted_Gap_ACS_minus_Cash_Adjusted_ARR"
]

NUM_COLS = 7
UNITS = ["MU", "Rs crore", "Rs crore", "Rs crore", "Rs crore", "Rs/kWh", "Rs/kWh"]
    ...
    with pdfplumber.open(pdf_path) as pdf:
        ...
        for year_label, page_indices in blocks:
            ...
            output_path = os.path.join(
                OUTPUT_FOLDER,
                f"Cash-Adjusted-Gap-{short_year}.csv"
            )
