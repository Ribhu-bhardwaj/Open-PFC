...
OUTPUT_FOLDER = (
    r"C:\Users\ribhu\csep-hermes\outputs\Revenue Structure\23-24"
)
...
COLUMNS = [
    ...
    "ARR_on_Tariff_Subsidy_Billed_Basis",
    "Tariff_Subsidy_Received",
    "ARR_on_Tariff_Subsidy_Received_Excl_Reg_Income_and_Revenue_Grant_UDAY"
]

NUM_COLS = 9
UNITS = ["MU", "Rs/kWh", "Rs/kWh", "Rs/kWh", "Rs/kWh", "Rs/kWh", "Rs/kWh", "Rs/kWh", "Rs/kWh"]
    ...
    with pdfplumber.open(pdf_path) as pdf:
        ...
        for year_label, page_indices in blocks:
            ...
            output_path = os.path.join(
                OUTPUT_FOLDER,
                f"Revenue-Structure-{short_year}.csv"
            )
